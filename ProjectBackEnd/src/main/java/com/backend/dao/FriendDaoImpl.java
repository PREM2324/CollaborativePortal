...
private SessionFactory sessionFactory;
	...
	public List<User> getSuggestedUsers(User user) {
		...
		SQLQuery query=session.createSQLQuery("select * from userslist where username in (select username from userslist where username!=? minus (select from_id from friends where to_id=?"
